Algoritmo bonusCalculator
	//This program calculates the total salary after applying the corresponding bonus
	// Ask the user to enter their base salary
	Escribir "Enter your base salary"
	leer baseSalary //Read theinput for the base salary
	...
	// Display the total salary after applying the bonus
