Algoritmo operadores
	...
	Si numeroElegido >= 1 Y numeroElegido <= 10 Entonces
		...
		Si numeroAComparar >= 1 Y numeroAComparar<= 10 Entonces
			...
			Escribir "¿El nNúmero elegido vs el comparado es igual ? ", numeroElegido == numeroAComparar
			Escribir "¿El úmero elegido vs el comparado es mayor o igual ? ", numeroElegido >= numeroAComparar
